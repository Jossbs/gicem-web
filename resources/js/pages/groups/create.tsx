        ...
        <>
            ...
            <div className="mb-6">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                    Complete la informacion para registrar un nuevo grupo.
                </p>
            </div>
                            ...
                            <Card className="overflow-hidden border-l-4 border-l-primary py-0 shadow-sm">
                                ...
                                <CardContent className="grid grid-cols-1 gap-6 px-6 py-6 md:grid-cols-2">
                                    <FormField label="NOMBRE DEL GRUPO *" error={errors.nombre_grupo}>
                                        <Input value={data.nombre_grupo} onChange={(e) => setData('nombre_grupo', e.target.value)} placeholder="Ej. 1-A" className="h-10" />
                                    </FormField>
                                    <FormField label="DOCENTE ASIGNADO *" error={errors.docente_id}>
                                        <Select value={data.docente_id} onValueChange={(v) => setData('docente_id', v)}>
                                            <SelectTrigger className="h-10"><SelectValue placeholder="Seleccionar docente" /></SelectTrigger>
                                            <SelectContent>
                                    ...
                                    <FormField label="NIVEL EDUCATIVO *" error={errors.nivel_educativo}>
                                        <Select value={data.nivel_educativo} onValueChange={(v) => setData('nivel_educativo', v)}>
                                            <SelectTrigger className="h-10"><SelectValue placeholder="Seleccionar nivel" /></SelectTrigger>
                                            <SelectContent>
                                    ...
                                    <FormField label="GRADO *" error={errors.grado}>
                                        <Select value={data.grado} onValueChange={(v) => setData('grado', v)}>
                                            <SelectTrigger className="h-10"><SelectValue placeholder="Seleccionar grado" /></SelectTrigger>
                                            <SelectContent>
                                    ...
                                    <FormField label="TURNO *" error={errors.turno}>
                                        <Select value={data.turno} onValueChange={(v) => setData('turno', v)}>
                                            <SelectTrigger className="h-10"><SelectValue placeholder="Seleccionar turno" /></SelectTrigger>
                                            <SelectContent>
                            ...
                            <Card className="overflow-hidden border-l-4 border-l-primary py-0 shadow-sm">
                                ...
                                <CardContent className="grid grid-cols-1 gap-6 px-6 py-6 md:grid-cols-2">
                                    <FormField label="AULA FISICA *" error={errors.aula_fisica}>
                                        <Input value={data.aula_fisica} onChange={(e) => setData('aula_fisica', e.target.value)} placeholder="Ej. Aula 3" className="h-10" />
                                    </FormField>
                                    <FormField label="CAPACIDAD MAXIMA *" error={errors.capacidad_maxima}>
                                        <Input type="number" min={1} max={50} value={data.capacidad_maxima} onChange={(e) => setData('capacidad_maxima', e.target.value)} placeholder="Ej. 15" className="h-10" />
                                    </FormField>
                                    <FormField label="CICLO ESCOLAR *" error={errors.ciclo_escolar}>
                                        <Input value={data.ciclo_escolar} onChange={(e) => setData('ciclo_escolar', e.target.value)} placeholder="Ej. 2025-2026" className="h-10" />
                                    </FormField>
